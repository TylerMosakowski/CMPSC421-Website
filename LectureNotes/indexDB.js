$(function () {
  ...
  /**
   * @param {number} biblioid
   * @param {number} title
   * @param {number} year
   * @param {string} file_input
   * @param {Blob=} blob
   */
  function addPublication(biblioid, title, year, file_input, blob) {
    console.log("addPublication arguments:", arguments);
    var obj = { biblioid: biblioid, title: title, year: year, file_input:file_input };
