...
public final class roster_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                console.log(content.java.array.void[0].object);\n");
      ...
      out.write("                 //   var fname = (content.java.array.void[])\n");
      out.write("                   // console.log(fname);\n");
      out.write("                    // get the values we want\n");
      out.write("                    //var void1 = field.find('string').text();\n");
      out.write("                    // and append some html in the <ol> element\n");
      out.write("                    //console.log(void1);\n");
      out.write("                    $(\"#mylist\")\n");
      out.write("                            .append('<tr><td>' + lname + '</td><td>' + fname '</td><td>'+ id + '</td><td>' + team + '</td></tr>');\n");
      out.write("\n");
      out.write("                        \n");
      out.write("                  });                \n");
      out.write("            };\n");
